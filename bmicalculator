...
image_icon=PhotoImage(file="C:/Users/Admin/Downloads/icon.png")
root.iconphoto(False,image_icon)

#top
top=PhotoImage(file="C:/Users/Admin/Downloads/top.png")
...
#two boxes
box=PhotoImage(file="C:/Users/Admin/Downloads/box.png")
Label(root,text="Height",image=box).place(x=20,y=100)
Label(root,text="Weight",image=box).place(x=240,y=100)

#scale
scale=PhotoImage(file="C:/Users/Admin/Downloads/scale.png")
Label(root,image=scale,bg="#F3CCFF").place(x=20,y=310)

#man image
secondimage=Label(root,bg="#F3CCFF")
...
def slider_changed(event):
    ...
    img=(Image.open("C:/Users/Admin/Downloads/man.png"))
...
#to change background colour of scale
style=ttk.Style()
...
label1=Label(root,font="arial 60",bg="#F3CCFF",fg="#fff")
label1.place(x=125,y=305)

label2=Label(root,font="arial 20",bg="#F3CCFF",fg="#3b3a3a")
label2.place(x=280,y=430)

label3=Label(root,font="arial 10",bg="#F3CCFF")
